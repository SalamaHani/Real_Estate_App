...
import { updateListingAction, fetchListingForEditAction } from "@/utils/admin-listing-actions";
...
export default function EditListingPage({ params }: { params: { id: string } }) {
    ...
    const [state, formAction, isPending] = useActionState(
        async (prevState: any, formData: FormData) => {
            ...
            const result = await updateListingAction(params.id, data);
    ...
    const fetchListing = async () => {
        try {
            const result = await fetchListingForEditAction(params.id);
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <Select name="listing_status" defaultValue={listing.listing_status} required>
                                    <SelectTrigger className="mt-1">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
                            ...
                            <div>
                                ...
                                <Select name="is_rental" defaultValue={listing.is_rental ? "true" : "false"} required>
                                    <SelectTrigger className="mt-1">
                                        <SelectValue />
                                    </SelectTrigger>
                                    <SelectContent>
